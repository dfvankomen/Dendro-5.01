...
int main(int argc, char** argv) {
    ...
    // double * ux=octDA->getVecPointerToDof(uSolVecPtr,VAR::M_UI_U,
    // false,false); double *
    // frhs=octDA->getVecPointerToDof(uSolVecPtr,VAR::M_UI_F, false,false);
    // double * Mfrhs=octDA->getVecPointerToDof(uSolVecPtr,VAR::M_UI_MF,
    // false,false);
