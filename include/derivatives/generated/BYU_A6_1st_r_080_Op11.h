// RE-EMITTED BYU_A6_1st_r_080_Op11.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,1.2e-05,4.5e-13,5.9e-09); (1,6,9.2e-07,1.1e-13,4.2e-10); (2,6,1.3e-10,1.1e-13,1.8e-13)
// yHat0 = 3.84
// yHat1 = 1.52
// yHat2 = 4.41
...
MatrixDiagonalEntries* createBYU_A6_1ST_R080_OP11_Diagonals(
	const std::vector<double>& D_coeffs) {
		...
		double a00 =  -3.808155803920283;
		double a01 =  -13.170317718874054;
		double a02 = 11.766687562777866;
		double a03 = 6.352902579780395;
		double a04 =  -1.3818189645041041;
		double a05 = 0.26841579014595524;
		double a06 =  -0.027713445405775635;
