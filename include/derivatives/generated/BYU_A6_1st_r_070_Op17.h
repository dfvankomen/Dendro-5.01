// RE-EMITTED BYU_A6_1st_r_070_Op17.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,7.8e-08,4.5e-13,8.9e-11); (1,6,2.5e-11,1.1e-13,6.6e-14); (2,6,3.0e-11,4.5e-13,3.8e-14)
// yHat0 = 0.63
// yHat1 = 0.95
// yHat2 = 1.53
