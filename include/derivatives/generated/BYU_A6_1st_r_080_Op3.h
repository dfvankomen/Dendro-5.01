...
MatrixDiagonalEntries* createBYU_A6_1ST_R080_OP3_Diagonals(
	const std::vector<double>& D_coeffs) {
		...
		double a00 =  - 3.5874599778195986;
		double a01 =  - 8.774603002014983;
		double a02 = 8.79842743713086;
		double a03 = 4.453733649173062;
		double a04 =  - 1.1165890310827613;
		double a05 = 0.257282263307327;
		double a06 =  - 0.030791338707217526;
