// RE-EMITTED BYU_A6_1st_r_075_Op26.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,3.0e-06,2.3e-13,3.3e-09); (1,6,8.3e-08,1.1e-13,1.4e-10); (2,6,1.2e-10,1.1e-13,7.3e-14)
// yHat0 = 1.74
// yHat1 = 2.45
// yHat2 = 4.44
