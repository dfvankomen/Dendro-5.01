// RE-EMITTED BYU_A6_1st_r_075_Op30.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,1.2e-05,9.1e-13,1.5e-08); (1,6,7.4e-08,4.4e-17,6.3e-11); (2,6,1.2e-10,1.1e-13,7.3e-14)
// yHat0 = 3.9
// yHat1 = 4.16
// yHat2 = 4.44
