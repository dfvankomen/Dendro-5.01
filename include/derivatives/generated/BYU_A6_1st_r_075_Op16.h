// RE-EMITTED BYU_A6_1st_r_075_Op16.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,2.4e-07,2.3e-13,6.5e-11); (1,6,5.0e-08,2.3e-13,4.2e-10); (2,6,2.4e-09,2.8e-14,1.0e-12)
// yHat0 = 0.69
// yHat1 = 1.49
// yHat2 = 2.1
