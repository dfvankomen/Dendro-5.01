// RE-EMITTED BYU_A6_1st_r_070_Op13.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,7.8e-08,4.5e-13,8.9e-11); (1,6,1.9e-08,4.5e-13,3.3e-12); (2,6,4.2e-11,4.3e-14,4.8e-14)
// yHat0 = 0.63
// yHat1 = 2.93
// yHat2 = 0.96
...
MatrixDiagonalEntries* createBYU_A6_1ST_R070_OP13_Diagonals(
	const std::vector<double>& D_coeffs) {
		...
		double gamma10 = 0.04817616415543026;
		double gamma12 = 2.881969043067444;
		double gamma13 = 1.477411707588635;
		...
		double a10 =  -0.2132561625383666;
		double a11 =  -1.9254522094894342;
		double a12 =  -0.6505286203132123;
		double a13 = 2.4971331517927937;
		double a14 = 0.31974697690822407;
		double a15 =  -0.029537820076119728;
		double a16 = 0.0018946837161148051;
