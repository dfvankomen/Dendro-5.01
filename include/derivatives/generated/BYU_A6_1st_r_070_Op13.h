...
MatrixDiagonalEntries* createBYU_A6_1ST_R070_OP13_Diagonals(
	const std::vector<double>& D_coeffs) {
		...
		double a10 =  - 0.21325616253876004;
		double a11 =  - 1.9254522094905662;
		double a12 =  - 0.6505286203125243;
		double a13 = 2.4971331517958943;
		double a14 = 0.3197469769115244;
		double a15 =  - 0.02953782007590461;
		double a16 = 0.001894683716105222;
