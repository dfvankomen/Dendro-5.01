// RE-EMITTED BYU_A6_1st_r_075_Op27.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,5.7e-05,9.1e-13,9.0e-08); (1,6,8.3e-08,1.1e-13,1.4e-10); (2,6,1.2e-10,1.1e-13,7.3e-14)
// yHat0 = 2.4
// yHat1 = 2.45
// yHat2 = 4.44
