// RE-EMITTED BYU_A6_1st_r_065_Op24.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,1.6e-06,4.5e-13,8.7e-09); (1,6,1.8e-09,4.5e-13,3.9e-11); (2,6,6.6e-11,2.8e-14,4.3e-14)
// yHat0 = 2.46
// yHat1 = 4.28
// yHat2 = 4.53
