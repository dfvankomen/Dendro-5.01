// RE-EMITTED BYU_A6_1st_r_080_Op12.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,7.9e-09,6.8e-13,1.3e-10); (1,6,1.6e-07,5.7e-14,8.6e-11); (2,6,1.3e-10,1.1e-13,1.8e-13)
// yHat0 = 0.72
// yHat1 = 2.45
// yHat2 = 4.41
