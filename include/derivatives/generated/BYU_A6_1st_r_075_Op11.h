// RE-EMITTED BYU_A6_1st_r_075_Op11.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,3.0e-06,2.3e-13,3.3e-09); (1,6,2.2e-10,2.3e-13,1.1e-12); (2,6,6.7e-11,7.1e-15,1.7e-14)
// yHat0 = 1.74
// yHat1 = 0.11
// yHat2 = 1.59
