...
MatrixDiagonalEntries* createBYU_A6_1ST_R070_OP19_Diagonals(
	const std::vector<double>& D_coeffs) {
		...
		double a10 =  - 0.2353524214539146;
		double a11 =  - 1.8152924071662027;
		double a12 =  - 0.4627337018456706;
		double a13 = 2.2426385615099163;
		double a14 = 0.29829186295694;
		double a15 =  - 0.029645076748170244;
		double a16 = 0.0020931827689595925;
