// RE-EMITTED BYU_A6_1st_r_065_Op3.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,1.4e-07,4.5e-13,1.1e-10); (1,6,6.1e-11,1.1e-13,5.9e-14); (2,6,1.8e-12,1.1e-13,6.7e-16)
// yHat0 = 0.57
// yHat1 = 0.89
// yHat2 = 0.3
