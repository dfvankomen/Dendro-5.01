// RE-EMITTED BYU_A6_1st_r_085_Op20.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,2.1e-06,1.1e-13,1.7e-09); (1,6,4.4e-09,1.8e-12,3.4e-12); (2,6,9.5e-11,4.5e-13,9.7e-14)
// yHat0 = 1.62
// yHat1 = 0.2
// yHat2 = 4.41
