// RE-EMITTED BYU_A6_1st_r_065_Op11.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,1.4e-07,4.5e-13,1.1e-10); (1,6,3.3e-10,1.1e-13,2.2e-13); (2,6,2.4e-11,2.8e-14,4.0e-14)
// yHat0 = 0.57
// yHat1 = -0.55
// yHat2 = 1.5
