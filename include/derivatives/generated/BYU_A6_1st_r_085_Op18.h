// RE-EMITTED BYU_A6_1st_r_085_Op18.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,2.1e-06,1.1e-13,1.7e-09); (1,6,7.6e-08,4.5e-13,2.0e-10); (2,6,4.5e-11,4.5e-13,2.9e-13)
// yHat0 = 1.62
// yHat1 = 4.07
// yHat2 = 3.33
