// RE-EMITTED BYU_A6_1st_r_085_Op29.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,2.1e-06,1.1e-13,1.7e-09); (1,6,2.7e-08,5.7e-14,8.8e-11); (2,6,9.5e-11,4.5e-13,9.7e-14)
// yHat0 = 1.62
// yHat1 = 3.8
// yHat2 = 4.41
...
MatrixDiagonalEntries* createBYU_A6_1ST_R085_OP29_Diagonals(
	const std::vector<double>& D_coeffs) {
		...
		double a10 =  -0.35596889888690064;
		double a11 =  -1.1984965615713432;
		double a12 = 1.2054118909931568;
		double a13 = 0.4950410658794249;
		double a14 =  -0.1749444755600669;
		double a15 = 0.032241490945221614;
		double a16 =  -0.0032845117994926313;
