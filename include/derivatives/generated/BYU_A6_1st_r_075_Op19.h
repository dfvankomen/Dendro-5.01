// RE-EMITTED BYU_A6_1st_r_075_Op19.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,2.4e-07,2.3e-13,6.5e-11); (1,6,3.9e-12,2.8e-14,9.7e-14); (2,6,1.2e-10,1.1e-13,7.3e-14)
// yHat0 = 0.69
// yHat1 = -0.28
// yHat2 = 4.44
