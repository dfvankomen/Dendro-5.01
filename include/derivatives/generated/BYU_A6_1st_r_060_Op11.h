// RE-EMITTED BYU_A6_1st_r_060_Op11.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,2.8e-08,3.6e-15,1.1e-10); (1,6,2.2e-07,3.6e-15,1.8e-10); (2,6,1.2e-11,4.5e-13,3.6e-14)
// yHat0 = 0.48
// yHat1 = 2.45
// yHat2 = 1.44
