// RE-EMITTED BYU_A6_1st_r_060_Op8.h: closure Q rows re-projected onto exact Taylor consistency (gamma unchanged unless a row needed a joint gamma+a correction).
// per row: (row, order, max residual before, after, max |delta a|): (0,6,2.5e-05,4.5e-13,1.1e-07); (1,6,5.4e-10,2.3e-13,2.7e-13); (2,6,1.2e-11,4.5e-13,3.6e-14)
// yHat0 = 4.17
// yHat1 = -0.16
// yHat2 = 1.44
