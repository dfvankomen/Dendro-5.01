 ...
 * octree based mesh generation. (these functions are transformed form the
 *mesh.h file. )
 */
//

namespace ot {
inline void Mesh::OCT_DIR_LEFT_INTERNAL_EDGE_MAP(
    ...
    if (lookUp1 != LOOK_UP_TABLE_DEFAULT) {
        if ((m_uiAllElements[lookUp1].getLevel() <
    ...
    if (lookUp2 != LOOK_UP_TABLE_DEFAULT) {
        if ((m_uiAllElements[lookUp2].getLevel() <
             m_uiAllElements[edgeOwner].getLevel()) ||
    ...
    if (edgeOwner == parent) {
        ...
        assert(m_uiAllElements[lookUp1].getLevel() <=
               m_uiAllElements[child].getLevel());
        if (lookUp2 == LOOK_UP_TABLE_DEFAULT ||
            m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
            edgeNodeIndex(lookUp1, OCT_DIR_RIGHT, OCT_DIR_DOWN, edgeOwnerIndex,
                          true);
        else
            edgeNodeIndex(lookUp1, OCT_DIR_LEFT, OCT_DIR_DOWN, edgeOwnerIndex,
                          true);

    } else {
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_LEFT, OCT_DIR_DOWN, edgeOwnerIndex,
                      true);
    }

    assert(edgeChildIndex.size() == edgeOwnerIndex.size());
    for (unsigned int index = 0; index < edgeChildIndex.size(); index++)
        m_uiE2NMapping_CG[edgeChildIndex[index]] =
            m_uiE2NMapping_CG[edgeOwnerIndex[index]];
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        ...
        if (edgeOwner == lookUp2) {
            assert(m_uiAllElements[lookUp2].getLevel() <=
                   m_uiAllElements[parent].getLevel());
            if (lookUp1 == LOOK_UP_TABLE_DEFAULT ||
                m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
                edgeNodeIndex(lookUp2, OCT_DIR_LEFT, OCT_DIR_DOWN,
                              edgeOwnerIndex, true);
            else
                edgeNodeIndex(lookUp2, OCT_DIR_RIGHT, OCT_DIR_DOWN,
                              edgeOwnerIndex, true);
        } else {
    ...
    if (edgeOwner == parent) {
        edgeNodeIndex(parent, OCT_DIR_RIGHT, OCT_DIR_DOWN, edgeOwnerIndex,
                      true);
    } else if (edgeOwner == lookUp1) {
        assert(m_uiAllElements[lookUp1].getLevel() <=
               m_uiAllElements[child].getLevel());
        if (lookUp2 == LOOK_UP_TABLE_DEFAULT ||
            m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
            edgeNodeIndex(lookUp1, OCT_DIR_RIGHT, OCT_DIR_UP, edgeOwnerIndex,
                          true);
        else
            edgeNodeIndex(lookUp1, OCT_DIR_LEFT, OCT_DIR_UP, edgeOwnerIndex,
                          true);
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        edgeNodeIndex(parent, OCT_DIR_RIGHT, OCT_DIR_DOWN, edgeChildIndex,
                      true);
        if (edgeOwner == lookUp2) {
            assert(m_uiAllElements[lookUp2].getLevel() <=
                   m_uiAllElements[parent].getLevel());
            if (lookUp1 == LOOK_UP_TABLE_DEFAULT ||
                m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
                edgeNodeIndex(lookUp2, OCT_DIR_LEFT, OCT_DIR_UP, edgeOwnerIndex,
                              true);
            else
                edgeNodeIndex(lookUp2, OCT_DIR_RIGHT, OCT_DIR_UP,
                              edgeOwnerIndex, true);
        } else {
            assert(edgeOwner == lookUp1);
            edgeNodeIndex(lookUp1, OCT_DIR_RIGHT, OCT_DIR_UP, edgeOwnerIndex,
    ...
    if (edgeOwner == parent) {
        edgeNodeIndex(parent, OCT_DIR_RIGHT, OCT_DIR_FRONT, edgeOwnerIndex,
                      true);
    } else if (edgeOwner == lookUp1) {
        assert(m_uiAllElements[lookUp1].getLevel() <=
               m_uiAllElements[child].getLevel());
        if (lookUp2 == LOOK_UP_TABLE_DEFAULT ||
            m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
            edgeNodeIndex(lookUp1, OCT_DIR_RIGHT, OCT_DIR_BACK, edgeOwnerIndex,
                          true);
        else
            edgeNodeIndex(lookUp1, OCT_DIR_LEFT, OCT_DIR_BACK, edgeOwnerIndex,
                          true);

    } else {
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_LEFT, OCT_DIR_BACK, edgeOwnerIndex,
                      true);
    }
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        edgeNodeIndex(parent, OCT_DIR_RIGHT, OCT_DIR_FRONT, edgeChildIndex,
                      true);
        if (edgeOwner == lookUp2) {
            assert(m_uiAllElements[lookUp2].getLevel() <=
                   m_uiAllElements[parent].getLevel());
            if (lookUp1 == LOOK_UP_TABLE_DEFAULT ||
                m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
                edgeNodeIndex(lookUp2, OCT_DIR_LEFT, OCT_DIR_BACK,
                              edgeOwnerIndex, true);
            else
                edgeNodeIndex(lookUp2, OCT_DIR_RIGHT, OCT_DIR_BACK,
                              edgeOwnerIndex, true);
        } else {
            assert(edgeOwner == lookUp1);
            edgeNodeIndex(lookUp1, OCT_DIR_RIGHT, OCT_DIR_BACK, edgeOwnerIndex,
    ...
    if (edgeOwner == parent) {
        edgeNodeIndex(parent, OCT_DIR_RIGHT, OCT_DIR_BACK, edgeOwnerIndex,
                      true);
    } else if (edgeOwner == lookUp1) {
        assert(m_uiAllElements[lookUp1].getLevel() <=
               m_uiAllElements[child].getLevel());
        if (lookUp2 == LOOK_UP_TABLE_DEFAULT ||
            m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
            edgeNodeIndex(lookUp1, OCT_DIR_RIGHT, OCT_DIR_FRONT, edgeOwnerIndex,
                          true);
        else
            edgeNodeIndex(lookUp1, OCT_DIR_LEFT, OCT_DIR_FRONT, edgeOwnerIndex,
                          true);

    } else {
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_LEFT, OCT_DIR_FRONT, edgeOwnerIndex,
                      true);
    }
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        edgeNodeIndex(parent, OCT_DIR_RIGHT, OCT_DIR_BACK, edgeChildIndex,
                      true);
        ...
        if (edgeOwner == lookUp2) {
            ...
            if (lookUp1 == LOOK_UP_TABLE_DEFAULT ||
                m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
                edgeNodeIndex(lookUp2, OCT_DIR_LEFT, OCT_DIR_FRONT,
                              edgeOwnerIndex, true);
            else
                edgeNodeIndex(lookUp2, OCT_DIR_RIGHT, OCT_DIR_FRONT,
                              edgeOwnerIndex, true);
        } else {
            assert(edgeOwner == lookUp1);
            edgeNodeIndex(lookUp1, OCT_DIR_RIGHT, OCT_DIR_FRONT, edgeOwnerIndex,
...
inline void Mesh::OCT_DIR_RIGHT_INTERNAL_EDGE_MAP(
    unsigned int child, unsigned int parent, bool parentChildLevEqual,
    std::vector<unsigned int> &edgeChildIndex,
    std::vector<unsigned int> &edgeOwnerIndex) {
    unsigned int edgeOwner;
    ...
    if (edgeOwner == parent) {
        ...
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_RIGHT, OCT_DIR_DOWN, edgeOwnerIndex,
                      true);
    }
    ...
    if (edgeOwner == parent) {
        edgeNodeIndex(parent, OCT_DIR_LEFT, OCT_DIR_FRONT, edgeOwnerIndex,
                      true);
        ...
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_RIGHT, OCT_DIR_BACK, edgeOwnerIndex,
                      true);
    }
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        edgeNodeIndex(parent, OCT_DIR_LEFT, OCT_DIR_FRONT, edgeChildIndex,
                      true);
        if (edgeOwner == lookUp2) {
            assert(m_uiAllElements[lookUp2].getLevel() <=
                   m_uiAllElements[parent].getLevel());
    ...
    if (edgeOwner == parent) {
        ...
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_RIGHT, OCT_DIR_FRONT, edgeOwnerIndex,
                      true);
    }
...
inline void Mesh::OCT_DIR_DOWN_INTERNAL_EDGE_MAP(
    unsigned int child, unsigned int parent, bool parentChildLevEqual,
    std::vector<unsigned int> &edgeChildIndex,
    std::vector<unsigned int> &edgeOwnerIndex) {
    unsigned int edgeOwner;
    ...
    if (edgeOwner == parent) {
        ...
        if (lookUp2 == LOOK_UP_TABLE_DEFAULT ||
            m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
            edgeNodeIndex(lookUp1, OCT_DIR_UP, OCT_DIR_LEFT, edgeOwnerIndex,
                          true);
        else
            edgeNodeIndex(lookUp1, OCT_DIR_DOWN, OCT_DIR_LEFT, edgeOwnerIndex,
                          true);
    } else {
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_DOWN, OCT_DIR_LEFT, edgeOwnerIndex,
                      true);
    }
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        ...
        if (edgeOwner == lookUp2) {
            ...
            if (lookUp1 == LOOK_UP_TABLE_DEFAULT ||
                m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
                edgeNodeIndex(lookUp2, OCT_DIR_DOWN, OCT_DIR_LEFT,
                              edgeOwnerIndex, true);
            else
                edgeNodeIndex(lookUp2, OCT_DIR_UP, OCT_DIR_LEFT, edgeOwnerIndex,
                              true);
        } else {
            assert(edgeOwner == lookUp1);
            edgeNodeIndex(lookUp1, OCT_DIR_UP, OCT_DIR_LEFT, edgeOwnerIndex,
    ...
    if (edgeOwner == parent) {
        ...
        if (lookUp2 == LOOK_UP_TABLE_DEFAULT ||
            m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
            edgeNodeIndex(lookUp1, OCT_DIR_UP, OCT_DIR_RIGHT, edgeOwnerIndex,
                          true);
        else
            edgeNodeIndex(lookUp1, OCT_DIR_DOWN, OCT_DIR_RIGHT, edgeOwnerIndex,
                          true);

    } else {
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_DOWN, OCT_DIR_RIGHT, edgeOwnerIndex,
                      true);
    }
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        ...
        if (edgeOwner == lookUp2) {
            ...
            if (lookUp1 == LOOK_UP_TABLE_DEFAULT ||
                m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
                edgeNodeIndex(lookUp2, OCT_DIR_DOWN, OCT_DIR_RIGHT,
                              edgeOwnerIndex, true);
            else
                edgeNodeIndex(lookUp2, OCT_DIR_UP, OCT_DIR_RIGHT,
                              edgeOwnerIndex, true);
        } else {
            assert(edgeOwner == lookUp1);
            edgeNodeIndex(lookUp1, OCT_DIR_UP, OCT_DIR_RIGHT, edgeOwnerIndex,
    ...
    if (edgeOwner == parent) {
        ...
        if (lookUp2 == LOOK_UP_TABLE_DEFAULT ||
            m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
            edgeNodeIndex(lookUp1, OCT_DIR_UP, OCT_DIR_BACK, edgeOwnerIndex,
                          true);
        else
            edgeNodeIndex(lookUp1, OCT_DIR_DOWN, OCT_DIR_BACK, edgeOwnerIndex,
                          true);

    } else {
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_DOWN, OCT_DIR_BACK, edgeOwnerIndex,
                      true);
    }
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        ...
        if (edgeOwner == lookUp2) {
            ...
            if (lookUp1 == LOOK_UP_TABLE_DEFAULT ||
                m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
                edgeNodeIndex(lookUp2, OCT_DIR_DOWN, OCT_DIR_BACK,
                              edgeOwnerIndex, true);
            else
                edgeNodeIndex(lookUp2, OCT_DIR_UP, OCT_DIR_BACK, edgeOwnerIndex,
                              true);
        } else {
            assert(edgeOwner == lookUp1);
            edgeNodeIndex(lookUp1, OCT_DIR_UP, OCT_DIR_BACK, edgeOwnerIndex,
    ...
    if (edgeOwner == parent) {
        ...
        if (lookUp2 == LOOK_UP_TABLE_DEFAULT ||
            m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
            edgeNodeIndex(lookUp1, OCT_DIR_UP, OCT_DIR_FRONT, edgeOwnerIndex,
                          true);
        else
            edgeNodeIndex(lookUp1, OCT_DIR_DOWN, OCT_DIR_FRONT, edgeOwnerIndex,
                          true);

    } else {
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_DOWN, OCT_DIR_FRONT, edgeOwnerIndex,
                      true);
    }
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        ...
        if (edgeOwner == lookUp2) {
            ...
            if (lookUp1 == LOOK_UP_TABLE_DEFAULT ||
                m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
                edgeNodeIndex(lookUp2, OCT_DIR_DOWN, OCT_DIR_FRONT,
                              edgeOwnerIndex, true);
            else
                edgeNodeIndex(lookUp2, OCT_DIR_UP, OCT_DIR_FRONT,
                              edgeOwnerIndex, true);
        } else {
            assert(edgeOwner == lookUp1);
            edgeNodeIndex(lookUp1, OCT_DIR_UP, OCT_DIR_FRONT, edgeOwnerIndex,
...
inline void Mesh::OCT_DIR_UP_INTERNAL_EDGE_MAP(
    unsigned int child, unsigned int parent, bool parentChildLevEqual,
    std::vector<unsigned int> &edgeChildIndex,
    std::vector<unsigned int> &edgeOwnerIndex) {
    unsigned int edgeOwner;
    ...
    if (edgeOwner == parent) {
        edgeNodeIndex(parent, OCT_DIR_DOWN, OCT_DIR_RIGHT, edgeOwnerIndex,
                      true);
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        edgeNodeIndex(parent, OCT_DIR_DOWN, OCT_DIR_RIGHT, edgeChildIndex,
                      true);
        if (edgeOwner == lookUp2) {
            assert(m_uiAllElements[lookUp2].getLevel() <=
                   m_uiAllElements[parent].getLevel());
    ...
    if (edgeOwner == parent) {
        edgeNodeIndex(parent, OCT_DIR_DOWN, OCT_DIR_FRONT, edgeOwnerIndex,
                      true);
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        edgeNodeIndex(parent, OCT_DIR_DOWN, OCT_DIR_FRONT, edgeChildIndex,
                      true);
        if (edgeOwner == lookUp2) {
            assert(m_uiAllElements[lookUp2].getLevel() <=
                   m_uiAllElements[parent].getLevel());
...
inline void Mesh::OCT_DIR_BACK_INTERNAL_EDGE_MAP(
    unsigned int child, unsigned int parent, bool parentChildLevEqual,
    std::vector<unsigned int> &edgeChildIndex,
    std::vector<unsigned int> &edgeOwnerIndex) {
    unsigned int edgeOwner;
    ...
    if (edgeOwner == parent) {
        edgeNodeIndex(parent, OCT_DIR_FRONT, OCT_DIR_LEFT, edgeOwnerIndex,
                      true);
        ...
        if (lookUp2 == LOOK_UP_TABLE_DEFAULT ||
            m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
            edgeNodeIndex(lookUp1, OCT_DIR_FRONT, OCT_DIR_RIGHT, edgeOwnerIndex,
                          true);
        else
            edgeNodeIndex(lookUp1, OCT_DIR_BACK, OCT_DIR_RIGHT, edgeOwnerIndex,
                          true);

    } else {
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_BACK, OCT_DIR_RIGHT, edgeOwnerIndex,
                      true);
    }
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        edgeNodeIndex(parent, OCT_DIR_FRONT, OCT_DIR_LEFT, edgeChildIndex,
                      true);
        if (edgeOwner == lookUp2) {
            assert(m_uiAllElements[lookUp2].getLevel() <=
                   m_uiAllElements[parent].getLevel());
            if (lookUp1 == LOOK_UP_TABLE_DEFAULT ||
                m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
                edgeNodeIndex(lookUp2, OCT_DIR_BACK, OCT_DIR_RIGHT,
                              edgeOwnerIndex, true);
            else
                edgeNodeIndex(lookUp2, OCT_DIR_FRONT, OCT_DIR_RIGHT,
                              edgeOwnerIndex, true);
        } else {
            assert(edgeOwner == lookUp1);
            edgeNodeIndex(lookUp1, OCT_DIR_FRONT, OCT_DIR_RIGHT, edgeOwnerIndex,
    ...
    if (edgeOwner == parent) {
        edgeNodeIndex(parent, OCT_DIR_FRONT, OCT_DIR_RIGHT, edgeOwnerIndex,
                      true);
        ...
        if (lookUp2 == LOOK_UP_TABLE_DEFAULT ||
            m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
            edgeNodeIndex(lookUp1, OCT_DIR_FRONT, OCT_DIR_LEFT, edgeOwnerIndex,
                          true);
        else
            edgeNodeIndex(lookUp1, OCT_DIR_BACK, OCT_DIR_LEFT, edgeOwnerIndex,
                          true);

    } else {
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_BACK, OCT_DIR_LEFT, edgeOwnerIndex,
                      true);
    }
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        edgeNodeIndex(parent, OCT_DIR_FRONT, OCT_DIR_RIGHT, edgeChildIndex,
                      true);
        if (edgeOwner == lookUp2) {
            assert(m_uiAllElements[lookUp2].getLevel() <=
                   m_uiAllElements[parent].getLevel());
            if (lookUp1 == LOOK_UP_TABLE_DEFAULT ||
                m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
                edgeNodeIndex(lookUp2, OCT_DIR_BACK, OCT_DIR_LEFT,
                              edgeOwnerIndex, true);
            else
                edgeNodeIndex(lookUp2, OCT_DIR_FRONT, OCT_DIR_LEFT,
                              edgeOwnerIndex, true);
        } else {
            assert(edgeOwner == lookUp1);
            edgeNodeIndex(lookUp1, OCT_DIR_FRONT, OCT_DIR_LEFT, edgeOwnerIndex,
    ...
    if (edgeOwner == parent) {
        edgeNodeIndex(parent, OCT_DIR_FRONT, OCT_DIR_DOWN, edgeOwnerIndex,
                      true);
        ...
        if (lookUp2 == LOOK_UP_TABLE_DEFAULT ||
            m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
            edgeNodeIndex(lookUp1, OCT_DIR_FRONT, OCT_DIR_UP, edgeOwnerIndex,
                          true);
        else
            edgeNodeIndex(lookUp1, OCT_DIR_BACK, OCT_DIR_UP, edgeOwnerIndex,
                          true);
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        edgeNodeIndex(parent, OCT_DIR_FRONT, OCT_DIR_DOWN, edgeChildIndex,
                      true);
        if (edgeOwner == lookUp2) {
            assert(m_uiAllElements[lookUp2].getLevel() <=
                   m_uiAllElements[parent].getLevel());
            if (lookUp1 == LOOK_UP_TABLE_DEFAULT ||
                m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
                edgeNodeIndex(lookUp2, OCT_DIR_BACK, OCT_DIR_UP, edgeOwnerIndex,
                              true);
            else
                edgeNodeIndex(lookUp2, OCT_DIR_FRONT, OCT_DIR_UP,
                              edgeOwnerIndex, true);
        } else {
            assert(edgeOwner == lookUp1);
            edgeNodeIndex(lookUp1, OCT_DIR_FRONT, OCT_DIR_UP, edgeOwnerIndex,
    ...
    if (edgeOwner == parent) {
        ...
        if (lookUp2 == LOOK_UP_TABLE_DEFAULT ||
            m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
            edgeNodeIndex(lookUp1, OCT_DIR_FRONT, OCT_DIR_DOWN, edgeOwnerIndex,
                          true);
        else
            edgeNodeIndex(lookUp1, OCT_DIR_BACK, OCT_DIR_DOWN, edgeOwnerIndex,
                          true);

    } else {
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_BACK, OCT_DIR_DOWN, edgeOwnerIndex,
                      true);
    }
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        ...
        if (edgeOwner == lookUp2) {
            ...
            if (lookUp1 == LOOK_UP_TABLE_DEFAULT ||
                m_uiAllElements[lookUp1] != m_uiAllElements[lookUp2])
                edgeNodeIndex(lookUp2, OCT_DIR_BACK, OCT_DIR_DOWN,
                              edgeOwnerIndex, true);
            else
                edgeNodeIndex(lookUp2, OCT_DIR_FRONT, OCT_DIR_DOWN,
                              edgeOwnerIndex, true);
        } else {
            assert(edgeOwner == lookUp1);
            edgeNodeIndex(lookUp1, OCT_DIR_FRONT, OCT_DIR_DOWN, edgeOwnerIndex,
...
inline void Mesh::OCT_DIR_FRONT_INTERNAL_EDGE_MAP(
    unsigned int child, unsigned int parent, bool parentChildLevEqual,
    std::vector<unsigned int> &edgeChildIndex,
    std::vector<unsigned int> &edgeOwnerIndex) {
    unsigned int edgeOwner;
    ...
    if (edgeOwner == parent) {
        ...
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_FRONT, OCT_DIR_RIGHT, edgeOwnerIndex,
                      true);
    }
    ...
    if (edgeOwner == parent) {
        edgeNodeIndex(parent, OCT_DIR_BACK, OCT_DIR_RIGHT, edgeOwnerIndex,
                      true);
        ...
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_FRONT, OCT_DIR_LEFT, edgeOwnerIndex,
                      true);
    }
    ...
    if ((parentChildLevEqual) && (edgeOwner != parent)) {
        edgeNodeIndex(parent, OCT_DIR_BACK, OCT_DIR_RIGHT, edgeChildIndex,
                      true);
        if (edgeOwner == lookUp2) {
            assert(m_uiAllElements[lookUp2].getLevel() <=
                   m_uiAllElements[parent].getLevel());
    ...
    if (edgeOwner == parent) {
        ...
        assert(edgeOwner == lookUp2);
        edgeNodeIndex(lookUp2, OCT_DIR_FRONT, OCT_DIR_DOWN, edgeOwnerIndex,
                      true);
    }
...
inline void Mesh::CORNER_NODE_MAP(unsigned int child) {
    // DEBUG HELPER CODE TO figure out Nodal mismatches. Be really carefull when
    ...
    /*if(m_uiActiveRank==1) {
        ...
        cusEleCheck.push_back(
                ot::TreeNode((x + ii_x * sz / m_uiElementOrder), (y + jj_y * sz
    / m_uiElementOrder), (z + kk_z * sz / m_uiElementOrder), m_uiMaxDepth,
    m_uiDim, m_uiMaxDepth)); treeNodesTovtk(cusEleCheck,child,"cusEleCheck");
    }*/
    ...
    for (unsigned int w = 0; w < numLookUp; w++) {
        if ((lookUp[w] != LOOK_UP_TABLE_DEFAULT) &&
    ...
    if (cornerOwner != child)
        m_uiE2NMapping_CG[cornerChildIndex] =
            m_uiE2NMapping_CG[cornerOwnerIndex];
...
inline void Mesh::faceNodesIndex(unsigned int elementID, unsigned int face,
    ...
    if (face == OCT_DIR_LEFT) {
        for (unsigned int k = begin; k < end; k++) {
            for (unsigned int j = begin; j < end; j++) {
                index[(k - begin) * (numPts1D) + (j - begin)] =
                    elementID * m_uiNpE +
        ...
        for (unsigned int k = begin; k < end; k++) {
            for (unsigned int i = begin; i < end; i++) {
                index[(k - begin) * (numPts1D) + (i - begin)] =
                    elementID * m_uiNpE +
                    k * (m_uiElementOrder + 1) * (m_uiElementOrder + 1) +
        ...
        for (unsigned int j = begin; j < end; j++) {
            for (unsigned int i = begin; i < end; i++) {
                index[(j - begin) * (numPts1D) + (i - begin)] =
                    elementID * m_uiNpE +
...
inline void Mesh::edgeNodeIndex(unsigned int elementID, unsigned int face1,
                                unsigned int face2,
                                std::vector<unsigned int> &index,
                                bool isInternal) const {
    unsigned int begin = 0;
    ...
    if (((face1 == OCT_DIR_LEFT) || (face1 == OCT_DIR_UP)) &&
        ((face2 == OCT_DIR_UP) || (face2 == OCT_DIR_LEFT))) {
        for (unsigned int k = begin; k < end; k++)
            index[(k - begin)] =
                elementID * m_uiNpE +
                k * (m_uiElementOrder + 1) * (m_uiElementOrder + 1) +
    ...
    } else if (((face1 == OCT_DIR_LEFT) || (face1 == OCT_DIR_DOWN)) &&
               ((face2 == OCT_DIR_DOWN) || (face2 == OCT_DIR_LEFT))) {
        for (unsigned int k = begin; k < end; k++)
            index[(k - begin)] =
                elementID * m_uiNpE +
                k * (m_uiElementOrder + 1) * (m_uiElementOrder + 1) +
    ...
    } else if (((face1 == OCT_DIR_LEFT) || (face1 == OCT_DIR_FRONT)) &&
               ((face2 == OCT_DIR_FRONT) || (face2 == OCT_DIR_LEFT))) {
        for (unsigned int j = begin; j < end; j++)
            index[(j - begin)] = elementID * m_uiNpE +
                                 m_uiElementOrder * (m_uiElementOrder + 1) *
                                     (m_uiElementOrder + 1) +
                                 j * (m_uiElementOrder + 1) + 0;

    } else if (((face1 == OCT_DIR_LEFT) || (face1 == OCT_DIR_BACK)) &&
               ((face2 == OCT_DIR_BACK) || (face2 == OCT_DIR_LEFT))) {
        for (unsigned int j = begin; j < end; j++)
            index[(j - begin)] =
                elementID * m_uiNpE +
                0 * (m_uiElementOrder + 1) * (m_uiElementOrder + 1) +
    ...
    } else if (((face1 == OCT_DIR_RIGHT) || (face1 == OCT_DIR_UP)) &&
               ((face2 == OCT_DIR_UP) || (face2 == OCT_DIR_RIGHT))) {
        for (unsigned int k = begin; k < end; k++)
            index[(k - begin)] =
                elementID * m_uiNpE +
                k * (m_uiElementOrder + 1) * (m_uiElementOrder + 1) +
                m_uiElementOrder * (m_uiElementOrder + 1) + m_uiElementOrder;

    } else if (((face1 == OCT_DIR_RIGHT) || (face1 == OCT_DIR_DOWN)) &&
               ((face2 == OCT_DIR_DOWN) || (face2 == OCT_DIR_RIGHT))) {
        for (unsigned int k = begin; k < end; k++)
            index[(k - begin)] =
                elementID * m_uiNpE +
                k * (m_uiElementOrder + 1) * (m_uiElementOrder + 1) +
    ...
    } else if (((face1 == OCT_DIR_RIGHT) || (face1 == OCT_DIR_FRONT)) &&
               ((face2 == OCT_DIR_FRONT) || (face2 == OCT_DIR_RIGHT))) {
        for (unsigned int j = begin; j < end; j++)
            index[(j - begin)] = elementID * m_uiNpE +
                                 m_uiElementOrder * (m_uiElementOrder + 1) *
                                     (m_uiElementOrder + 1) +
    ...
    } else if (((face1 == OCT_DIR_RIGHT) || (face1 == OCT_DIR_BACK)) &&
               ((face2 == OCT_DIR_BACK) || (face2 == OCT_DIR_RIGHT))) {
        for (unsigned int j = begin; j < end; j++)
            index[(j - begin)] =
                elementID * m_uiNpE +
                0 * (m_uiElementOrder + 1) * (m_uiElementOrder + 1) +
    ...
    } else if (((face1 == OCT_DIR_UP) || (face1 == OCT_DIR_FRONT)) &&
               ((face2 == OCT_DIR_FRONT) || (face2 == OCT_DIR_UP))) {
        for (unsigned int i = begin; i < end; i++)
            index[(i - begin)] = elementID * m_uiNpE +
                                 m_uiElementOrder * (m_uiElementOrder + 1) *
                                     (m_uiElementOrder + 1) +
                                 m_uiElementOrder * (m_uiElementOrder + 1) + i;

    } else if (((face1 == OCT_DIR_UP) || (face1 == OCT_DIR_BACK)) &&
               ((face2 == OCT_DIR_BACK) || (face2 == OCT_DIR_UP))) {
        for (unsigned int i = begin; i < end; i++)
            index[(i - begin)] =
                elementID * m_uiNpE +
                0 * (m_uiElementOrder + 1) * (m_uiElementOrder + 1) +
    ...
    } else if (((face1 == OCT_DIR_DOWN) || (face1 == OCT_DIR_FRONT)) &&
               ((face2 == OCT_DIR_FRONT) || (face2 == OCT_DIR_DOWN))) {
        for (unsigned int i = begin; i < end; i++)
            index[(i - begin)] = elementID * m_uiNpE +
                                 m_uiElementOrder * (m_uiElementOrder + 1) *
                                     (m_uiElementOrder + 1) +
    ...
    } else if (((face1 == OCT_DIR_DOWN) || (face1 == OCT_DIR_BACK)) &&
               ((face2 == OCT_DIR_BACK) || (face2 == OCT_DIR_DOWN))) {
        for (unsigned int i = begin; i < end; i++)
            index[(i - begin)] =
                elementID * m_uiNpE +
                0 * (m_uiElementOrder + 1) * (m_uiElementOrder + 1) +
...
inline void Mesh::cornerNodeIndex(unsigned int elementID,
                                  unsigned int mortonIndex,
                                  unsigned int &index) const {
    if (mortonIndex == 0) {
        index = elementID * m_uiNpE +
                0 * (m_uiElementOrder + 1) * (m_uiElementOrder + 1) +
                0 * (m_uiElementOrder + 1) + 0;
        ...
        index =
            elementID * m_uiNpE +
            m_uiElementOrder * (m_uiElementOrder + 1) * (m_uiElementOrder + 1) +
            0 * (m_uiElementOrder + 1) + 0;
...
inline void Mesh::elementNodeIndex(unsigned int elementID,
                                   std::vector<unsigned int> &index,
                                   bool isInternal) const {
    unsigned int begin = 0;
    unsigned int end   = (m_uiElementOrder + 1);
    ...
    for (unsigned int k = begin; k < end; k++) {
        for (unsigned int j = begin; j < end; j++) {
            for (unsigned int i = begin; i < end; i++) {
                index[(k - begin) * numPts1D * numPts1D +
                      (j - begin) * numPts1D + (i - begin)] =
                    elementID * m_uiNpE +
                    k * (m_uiElementOrder + 1) * (m_uiElementOrder + 1) +
                    j * (m_uiElementOrder + 1) + i;
            }
...
inline void Mesh::OCT_DIR_DIAGONAL_E2E(unsigned int elementID,
                                       unsigned int face1, unsigned int face2,
...
inline unsigned int Mesh::getDIROfANode(unsigned int ii_x, unsigned int jj_y,
                                        unsigned int kk_z) {
    ...
    if (stateX[0] && stateY[0] && stateZ[0]) return OCT_DIR_INTERNAL;
    ...
    if (stateZ[0] && stateY[0] && stateX[1]) return OCT_DIR_LEFT;

    if (stateZ[0] && stateY[0] && stateX[2]) return OCT_DIR_RIGHT;

    if (stateZ[0] && stateX[0] && stateY[1]) return OCT_DIR_DOWN;

    if (stateZ[0] && stateX[0] && stateY[2]) return OCT_DIR_UP;

    if (stateX[0] && stateY[0] && stateZ[1]) return OCT_DIR_BACK;

    if (stateX[0] && stateY[0] && stateZ[2]) return OCT_DIR_FRONT;

    // internal corners.

    if (stateZ[0] && stateX[1] && stateY[1]) return OCT_DIR_LEFT_DOWN;

    if (stateZ[0] && stateX[1] && stateY[2]) return OCT_DIR_LEFT_UP;

    if (stateY[0] && stateX[1] && stateZ[1]) return OCT_DIR_LEFT_BACK;

    if (stateY[0] && stateX[1] && stateZ[2]) return OCT_DIR_LEFT_FRONT;

    if (stateZ[0] && stateX[2] && stateY[1]) return OCT_DIR_RIGHT_DOWN;

    if (stateZ[0] && stateX[2] && stateY[2]) return OCT_DIR_RIGHT_UP;

    if (stateY[0] && stateX[2] && stateZ[1]) return OCT_DIR_RIGHT_BACK;

    if (stateY[0] && stateX[2] && stateZ[2]) return OCT_DIR_RIGHT_FRONT;

    if (stateX[0] && stateZ[1] && stateY[1]) return OCT_DIR_DOWN_BACK;

    if (stateX[0] && stateZ[2] && stateY[1]) return OCT_DIR_DOWN_FRONT;

    if (stateX[0] && stateZ[1] && stateY[2]) return OCT_DIR_UP_BACK;

    if (stateX[0] && stateZ[2] && stateY[2]) return OCT_DIR_UP_FRONT;
