...
// ---------------------------------------------------------------------------
// Chebyshev codec -- NOT BUILT.
// It is unreachable at runtime (COMP_CHEBYSHEV is never registered in the
// compressor factory, so requesting it throws), and its transform matrices
// (include/generated/cheb_*.inc.h + *.bin, ~80k lines) were left on the
// ghost_compression branch rather than carried into this tree for a codec
// nothing can call. Define DENDRO_COMPRESSION_CHEBYSHEV and restore
// include/generated/ from that branch to build it again.
// ---------------------------------------------------------------------------
#ifdef DENDRO_COMPRESSION_CHEBYSHEV
...
#endif  // DENDRO_COMPRESSION_CHEBYSHEV
