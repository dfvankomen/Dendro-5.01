...
// The learned backends (and their onnxruntime / libtorch dependencies) were not
// carried over from the ghost_compression branch -- see the note in the
// Ghost Compression vault. Restore compressor_onnx.hpp / compressor_torchscript.hpp
// from that branch and define DENDRO_ENABLE_ML_LIBRARIES to build them.
...
#endif  // DENDRO_ENABLE_ML_LIBRARIES
