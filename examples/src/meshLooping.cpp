...
int main(int argc, char** argv) {
        ...
        if (!rank)
            std::cout << "Usage :" << argv[0] << " numPts "
                      ...
                      << " distribution (default =0) (0- Normal 1- Uniform 2- "
                         "LogarithmicNormal) SplitterFixK (default =2)"
                      << std::endl;
    }
    ...
    if (npes >= 2) {
        ...
        if (!rank) {
            std::cout << "octree construction + balance  time: " << t_g
                      << std::endl;
            std::cout << "Number of bal octs: " << globalSz << std::endl;
        }

        if (!rank)
            std::cout << "Number of balanced octants: " << globalSz
                      << std::endl;
        ...
        if (!rank) std::cout << "Mesh time: " << t_g << std::endl;
